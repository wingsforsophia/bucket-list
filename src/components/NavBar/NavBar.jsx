      ...
      {user ?
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <ul className="navbar-nav mr-auto">
              ...
              <Link className="nav-link dropdown-toggle" href="/trips" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Trips</Link>
              <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                <a className="dropdown-item" href="/addtrip">Add Trips</a>
                <a className="dropdown-item" href="/trips">View Trips</a>
            </div>
